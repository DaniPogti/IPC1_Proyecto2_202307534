...
function Usuario() {
    ...
    useEffect(() => {
        console.log(likes); // Verificar el estado actualizado
                    ...
                    posts.map((item, index) => (
                        <div className="card mb-3 mb-5" key={index}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">{item.carfacu}</p>
                                <p className="card-text">{item.categoria}</p>
                                <button className={(" " + SiLike ? "hola" : "")} onClick={onBotonLikeClick}>Me gusta {item.like} / {likes}
                                </button>
